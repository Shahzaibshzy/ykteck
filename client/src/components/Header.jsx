...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-10" data-aos="fade-up">
      <div className="flex justify-between items-center px-4 md:px-8 py-4 text-white bg-black bg-opacity-10 backdrop-blur-md">
        {/* Left - Logo */}
        <img src={logo} alt="logo" className="hidden sm:w-10 md:w-28 lg:block w-36 ml-24" />

        {/* Desktop Nav */}
        <nav className="hidden lg:flex  absolute right-10 transform -translate-x-1/2 space-x-10 md:text-xl lg:text-2xl font-semibold ">
        <Link
        to="/"
  ...
  "
      ...
      >
        ...
        {/* <a
          ref="https://www.linkedin.com/company/102501800"
          target="_blank"
          rel="noopener noreferrer"
          className="block w-full text-left text-xl px-4 py-2 rounded-md transition-all duration-300 ease-in-out hover:bg-gray-200 hover:text-black"
        >
